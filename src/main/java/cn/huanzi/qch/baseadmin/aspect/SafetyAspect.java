       ...
       try {
           ...
           if("N".equals(SysSettingUtil.getSysSetting().getSysApiEncrypt())){
            ...
            if ("post".equals(httpMethod) && hasDecrypt) {
                ...
                //后端私钥解密的到AES的key
                byte[] plaintext = RsaUtil.decryptByPrivateKey(Base64.decodeBase64(aesKey.getBytes()), RsaUtil.getPrivateKey());
            ...
            if (hasEncrypt) {
                ...
                String aesKey = Base64.encodeBase64(RsaUtil.encryptByPublicKey(key.getBytes(), publicKey)).toString();
